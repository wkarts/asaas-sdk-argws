...
use Asaas\Sdk\Service\Generated\PaymentSplitService as GeneratedPaymentSplitService;
 ...
 *
 * @mixin GeneratedPaymentSplitService
 */
final class PaymentSplitService extends AbstractService
{
    private GeneratedPaymentSplitService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedPaymentSplitService($client);
    }
