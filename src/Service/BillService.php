...
use Asaas\Sdk\Service\Generated\BillService as GeneratedBillService;
 ...
 *
 * @mixin GeneratedBillService
 */
final class BillService extends AbstractService
{
    private GeneratedBillService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedBillService($client);
    }
