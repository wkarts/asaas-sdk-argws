...
use Asaas\Sdk\Service\Generated\PaymentLinkService as GeneratedPaymentLinkService;
 ...
 *
 * @mixin GeneratedPaymentLinkService
 */
final class PaymentLinkService extends AbstractService
{
    private GeneratedPaymentLinkService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedPaymentLinkService($client);
    }
