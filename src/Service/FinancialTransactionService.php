 ...
 *
 * @mixin GeneratedFinancialTransactionService
 */
final class FinancialTransactionService extends AbstractService
{
    private GeneratedFinancialTransactionService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedFinancialTransactionService($client);
    }
