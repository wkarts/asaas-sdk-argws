 ...
 *
 * @mixin GeneratedPixTransactionService
 */
final class PixTransactionService extends AbstractService
{
    private GeneratedPixTransactionService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedPixTransactionService($client);
    }
