 ...
 *
 * @mixin GeneratedPaymentRefundService
 */
final class PaymentRefundService extends AbstractService
{
    private GeneratedPaymentRefundService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedPaymentRefundService($client);
    }
