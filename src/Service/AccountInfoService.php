...
use Asaas\Sdk\Service\Generated\AccountInfoService as GeneratedAccountInfoService;
 ...
 *
 * @mixin GeneratedAccountInfoService
 */
final class AccountInfoService extends AbstractService
{
    private GeneratedAccountInfoService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedAccountInfoService($client);
    }
