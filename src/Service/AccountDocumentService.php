 ...
 *
 * @mixin GeneratedAccountDocumentService
 */
final class AccountDocumentService extends AbstractService
{
    private GeneratedAccountDocumentService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedAccountDocumentService($client);
    }
