 ...
 *
 * @mixin GeneratedPaymentDocumentService
 */
final class PaymentDocumentService extends AbstractService
{
    private GeneratedPaymentDocumentService $generated;

    public function __construct(Client $client)
    {
        parent::__construct($client);
        $this->generated = new GeneratedPaymentDocumentService($client);
    }
